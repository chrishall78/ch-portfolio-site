function CFormatText2 (iX, iY, szText, szColor, oParentContainer, szGlow, iSize){
    ...
    this._init = function(iX, iY, szText, szColor, oParentContainer, szGlow, iSize){    
        ...
        _oTextOutline.font = szFontTag+ " "+ SECONDARY_FONT;
        ...
        _oText.text = _szText;
        _oText.font = szFontTag+" " + SECONDARY_FONT;
